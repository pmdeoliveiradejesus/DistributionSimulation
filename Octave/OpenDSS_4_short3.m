% OpenDSS Short Circuit - 4 wire: three phase a to neutral
%
%      0        1        2 
% kVLL |---zg---|---z----|--->S
%                        |---rf---x
%
function [V,Iwide]=OpenDSS_4_short3(ygabcn,zabcn,Sabc,ylabcn,yshabcn)
global kVLN 
global YbusO
global rf 
global r1 
...
x0=[real(V0);real(V0);imag(V0);imag(V0);0;0;0;0;0;0];
...
i2(2,1)=0*conj(-Sabc(2)/(V2(2,1)-V2(4,1)))+complex(x(19),x(20));% compensation injected currents at bus loads
i2(3,1)=0*conj(-Sabc(3)/(V2(3,1)-V2(4,1)))+complex(x(21),x(22));% compensation injected currents at bus loads
...
ic1=ygabcn*V0-0.5*yshabcn*V1;
        ...
        i2(2,1)=0*conj(-Sabc(2)/(V2(2,1)-V2(4,1)))+complex(x(19),x(20));% injected currents at bus loads
        i2(3,1)=0*conj(-Sabc(3)/(V2(3,1)-V2(4,1)))+complex(x(21),x(22));%  injected currents at bus loads
        i2(4,1)=-i2(1,1)-i2(2,1)-i2(3,1)-V2(4)/(r3);
...
F(19)=real(V2(2,1)-V2(4,1)+i2(2,1)*rf);
F(20)=imag(V2(2,1)-V2(4,1)+i2(2,1)*rf);
F(21)=real(V2(3,1)-V2(4,1)+i2(3,1)*rf);
F(22)=imag(V2(3,1)-V2(4,1)+i2(3,1)*rf);
end
